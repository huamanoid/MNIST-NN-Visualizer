const MODEL_URL =
  "https://raw.githubusercontent.com/huamanoid/Image-Classifier/main/modelv1/tensorflowjs_model.pb";
const WEIGHTS_URL =
  "https://raw.githubusercontent.com/huamanoid/Image-Classifier/main/modelv1/weights_manifest.json";
let model;
let IMAGENET_CLASSES = [];
let offset = tf.scalar(128);
async function loadModelAndClasses() {
  $.getJSON(
  "https://raw.githubusercontent.com/huamanoid/Image-Classifier/main/imagenet_classes.json",
    function(data) {
